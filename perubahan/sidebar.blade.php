<aside class="main-sidebar">
    <section class="sidebar">
        ...
        <ul class="sidebar-menu" data-widget="tree">
            ...
            @php
                $main_modules = ['Beranda', 'Info Desa', 'Admin Web', 'Pengaturan', 'Pesan dari Tim MMD'];
            @endphp
            <?php foreach ($modul as $mod): ?>
            {{-- <?php log_message('error', print_r($mod . ' // ' . $mod['submodul'], true)); ?> --}}
            <?php if (count($mod['submodul']) == 0 && in_array($mod['modul'], $main_modules)): ?>
            ...
            <?php elseif (in_array($mod['modul'], $main_modules)): ?>
            ...
            <li class="header">MENU LANJUTAN</li>
