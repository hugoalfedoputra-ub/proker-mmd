	...
	<section class="content" id="maincontent">
		<form id="" action="<?= $form_action; ?>" method="POST" enctype="multipart/form-data">
			<div class="form-group">
				...
				<input id="judul" name="judul" class="form-control input-xlg required strip_tags judul" type="text" placeholder="Tulis judul artikel Anda di sini..." minlength="5" maxlength="200" value="<?= $artikel['judul'] ?>" required></input>
			...
			<div class="input-group input-group-xlg">
				...
				<span class="input-group-btn">
					...
					<label for="upload-file-gambar" class="btn btn-info btn-flat"><i class="fa fa-search"></i> Cari dari Perangkat Anda</label>
				</span>
			</div>
			...
			<span class="help-block"><code>Gambar(-gambar) yang diunggah menggunakan cara di atas <b>selalu muncul pertama kali pada artikel</b>. Apabila ingin menambahkan gambar sesuai posisi pada teks, silakan gunakan editor teks di bawah.</code></span>
...
<script type="text/javascript">
	...
	fileInput.addEventListener('change', (event) => {
		...
		theParent.childNodes.forEach((child) => {
			...
			child.childNodes[1].childNodes[0].setAttribute('onclick', 'removePreviewImage(\'' + filePaths[counter] + '\',' + counter + ')')
			counter++
		})
